...
export const metadata: Metadata = {
  title: "Ghanshyam.dev - Full Stack Developer Portfolio",
  description:
    "Explore Ghanshyam Choudhary portfolio, an experienced MERN stack developer specializing in full-stack web development with expertise in React, Node.js, and more.",
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="description"
          content="Explore Ghanshyam Choudhary portfolio, an experienced MERN stack developer specializing in full-stack web development."
        />
        <meta
          name="keywords"
          content="Ghanshyam Choudhary, MERN Stack Developer, Portfolio, Web Development, Full-Stack, React, Next.js, Node.js"
        />
        <meta name="author" content="Ghanshyam Choudhary" />

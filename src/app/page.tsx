      ...
      <div className="w-full h-full  max-w-screen-lg px-4 ">
        <section id="home" className="w-full h-full mb-40">
          <div className="w-full md:text-8xl text-5xl text-center   text-[#ff6f009a] font-light md:mb-20 mb-10 mt-10 md:py-16 py-8 header-font ">
            ...
            />
            web app with MERN stack and AI integrations
          </div>
          <div className="w-full flex md:flex-row flex-col ">
            ...
            <div className="md:w-1/2 w-full md:text-lg text-sm text-gray-600 md:text-left text-center mt-5">
              👋 Hi there, I&apos;m Ghanshyam Choudhary! I&apos;m a
              results-driven MERN stack developer with a passion for building
              cutting-edge web applications that make an impact. <br />
              <span className="md:flex hidden">
                I&apos;ve honed my skills in MongoDB, Express.js, React.js, Next.js and
              ...
              <br />
              <span className="md:flex hidden">
                🚀 I also integrate AI capabilities into web applications using
                technologies like Large Language Models (LLMs), LangChain, and
                AI agents—enabling intelligent automation, natural language
                processing, and enhanced user experiences.
              </span>
            </div>
          </div>
        </section>
